...
func NewConsulServiceRegister(consulClient *api.Client) (base.ServiceDiscoveryRegister, base.Error) {
	if consulClient == nil {
		return nil, base.NewError(base.ERRCODE_BASE_SYSTEM_INIT_ERROR, err_scope_consul_register, "没有指定 consulClient")
	}
...
func (this *consulServiceRegister) RegService(serviceInfo base.ServiceInfo, serviceAddr string, cxt context.Context) base.Error {
	...
	if err != nil {
		...
		return base.NewError(base.ERRCODE_BASE_SYSTEM_SERVICE_REGISTER_ERROR, err_scope_consul_register, err.Error())
	}
...
func GetConsulClient(cxt context.Context) (*api.Client, base.Error) {
	...
	if i == nil {
		return nil, base.NewError(base.ERRCODE_BASE_SYSTEM_INIT_ERROR, err_scope_consul_register, "no create consul client")
	}
