...
func RequestFormBodyEncoder(data interface{}, request *http.Request) base.Error {
	...
	if !ok {
		return base.NewError(base.ERROR_CODE_BASE_ENCODE_ERROR, "request body 参数不是 url.Values类型")
	}
...
func RequestJsonBodyEncoder(data interface{}, request *http.Request) base.Error {
	...
	if err != nil {
		return base.NewError(base.ERROR_CODE_BASE_ENCODE_ERROR, err.Error())
	}
...
func RequestPBBodyEncoder(data interface{}, request *http.Request) base.Error {
	...
	if !ok {
		return base.NewError(-1, "data not implement proto.Message")
	}
